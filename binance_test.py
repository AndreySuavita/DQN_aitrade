...
def binance_test(device, window_size, time_cycle, initial_balance, binance_on, with_binance_balance):
    ...
    test_return, portfolio_history, price_history, actions_history = evaluate(
        agent, test_env, scaler, initial_balance=initial_balance, binance_on=binance_on, time_cycle=time_cycle,with_binance_balance=with_binance_balance
    )
